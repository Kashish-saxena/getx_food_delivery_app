...
class SignInSignUpScreen extends StatelessWidget {
  ...
  SignInSignUpViewModel signInSignUpViewModel = Get.find();
  ...
  Widget buildRegisterationTab(context) {
          ...
          child: Column(
            ...
            children: [
              TextFormFieldWidget(
                ...
                validator: (val) {
                  return SignUpValidations.isNameValid(val);
                },
              ...
              TextFormFieldWidget(
                ...
                validator: (value) {
                  return SignUpValidations.isEmailValid(value);
                },
                labelText: StringConstants.email,
              ),
              TextFormFieldWidget(
                ...
                labelText: StringConstants.password,
                validator: (value) {
                  return SignUpValidations.isPasswordValid(value);
                },
                obscureText: true,
              ),
              TextFormFieldWidget(
                onChanged: (value) {
                  signInSignUpViewModel.registerConfirmPassword(value);
                },
                  ...
                  child: ButtonWidget(
                    ...
                    onPressed: () {
                      if (signInSignUpViewModel.registerKey.currentState
                              ?.validate() ??
                          false) {
                        signInSignUpViewModel.postUser(SignUpRequestModel(
                            name: signInSignUpViewModel.registerName.value,
                            email: signInSignUpViewModel.registerEmail.value,
